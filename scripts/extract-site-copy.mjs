...
let fullMarkdown = `# spwashi.com — Consolidated Site Copy for Team Reading\n\n` +
  `*Human reading aid. Not always-on. Regenerated by \`scripts/extract-site-copy.mjs\`. ` +
...
const outputPath = path.join(workspaceRoot, '.agents/plans/archive/team-orientation-reading.md');
