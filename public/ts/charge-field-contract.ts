...
export type ChargePhase = keyof typeof PHASE_INTENSITY;
export type ChargeDecayState = Readonly<{
  field: 'quiet' | 'bleeding';
  intensity: number;
}>;
...
export function decayCharge(intensity: number): ChargeDecayState {
