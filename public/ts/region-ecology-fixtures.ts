...
export const REGION_ECOLOGY_FIXTURES = Object.freeze([
  ...
  },
  {
    ...
    seat: 'cluster',
    selector: '#boonhonk-register .frame-operators[data-spw-feature="theme-chips"]',
  ...
  },
  {
    ...
    layoutScenarios: ['pocket', 'fold', 'broadsheet'],
    socialAspects: ['fit', 'og'],
    captureValue: 'Labeled atlas diagram, visit/world lens, landmark path, climate rail.',
    chapter: 'region',
    liminality: 'entry',
    wonder: 'A pocket crop should name library → card without the origin prose.',
  },
  {
    id: 'research-hook',
    label: 'Research hook',
    ...
    layoutScenarios: ['pocket', 'fold', 'broadsheet'],
    socialAspects: ['fit', 'landscape'],
    captureValue: 'Cite/decide lens, insight ladder SVG, tropes rail.',
    chapter: 'region',
    liminality: 'entry',
    wonder: 'The ladder rungs should photograph as named marks, not a caption dump.',
  },
  {
    id: 'membership-hook',
    label: 'Membership hook',
    seat: 'hook',
    ...
    chapter: 'region',
    liminality: 'entry',
    wonder: 'Roles around the issue bed should be nameable in a still.',
  },
  {
    id: 'svg-storytelling-hook',
    label: 'SVG storytelling hook',
    seat: 'hook',
    selector: '#svg-storytelling',
    specimenRoute: '/topics/craft/svg/',
    cssOwner: 'public/css/systems/svg-surfaces.css',
    layoutScenarios: ['pocket', 'fold', 'broadsheet'],
    socialAspects: ['fit', 'landscape'],
    captureValue: 'Motif kit with glyph, creature, divider, token still readable.',
    chapter: 'region',
    liminality: 'entry',
    wonder: 'A still of the kit should name the four marks without the whole essay.',
  },
