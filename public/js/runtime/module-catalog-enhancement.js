...
export const ENHANCEMENT_DEFS = [
  ...
  },
  {
    ...
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.VISIBLE,
    subfeatures: ['mode-switch-pivot', 'semantic-lens-activator', 'content-variant-framer'],
    triggers: ['operator-touch', 'keyboard-chord'],
    affordances: ['toggle-lens-state', 'switch-content-layer', 'compare-variants'],
  ...
  },
  {
    ...
    when: MOUNT_WHEN.VISIBLE,
    costClass: COST_CLASS.DEMAND_COUPLED,
    subfeatures: ['in-situ-expression-editor', 'boundary-morph-hud', 'concept-scene-mode-payload-differentiator', 'cauldron-ingredient-bridge'],
    triggers: ['operator-touch', 'pointer-approach'],
    affordances: ['edit-expression-inline', 'morph-boundary-geometry', 'compare-mode-vs-payload', 'deposit-edited-cauldron-ingredient'],
    ...
    rootMode: 'single',
    describes: 'interactive[expression]{edit|autocomplete|compare} boundary geometry and differential HUD',
    updates: [
