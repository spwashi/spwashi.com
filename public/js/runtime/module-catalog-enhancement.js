...
export const ENHANCEMENT_DEFS = [
  ...
  },
  {
    ...
    when: MOUNT_WHEN.VISIBLE,
    costClass: COST_CLASS.PAINT_COMPOSITE,
    subfeatures: ['section-handle-locomotion', 'resonance-probe', 'reading-groove'],
    triggers: ['scroll-boundary', 'pointer-approach'],
    affordances: ['jump-to-current-section', 'operator-echo-highlight', 'groove-aligned-reading'],
