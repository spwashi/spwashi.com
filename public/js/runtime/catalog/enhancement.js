...
export const ENHANCEMENT_DEFS = [
  ...
  },
  {
    ...
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.VISIBLE,
    // the same hosts image-metaphysics remembers; the count is read where a surface could be remembered
    selector: '.image-study, .topic-photo-card, .spw-svg-figure, [data-spw-image-surface], .domain-visual, .spw-scaffold',
    rootMode: 'single',
    describes: 'visited[surfaces]{count|on-page} the surfaces already looked at count themselves on the root, here and across pages',
    updates: [
      'html:residue:data-spw-visited-surface-count',
      'html:residue:data-spw-visited-on-page',
      'body:residue:data-spw-visited-surface-count',
      'body:residue:data-spw-visited-on-page',
    ],
  ...
  },
  {
    ...
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.IDLE,
    selector: '[data-spw-feature="cauldron"], [data-spw-cauldron], #memory-garden-cauldron, #media-cauldron',
    rootMode: 'single',
  ...
  },
  {
    ...
    rootMode: 'single',
    describes: 'attention[operator|concept|ingredient|relation] resonance probe',
    updates: [
      'flourish:data-spw-resonance-probe',
      'flourish:data-spw-resonance-family',
      'flourish:data-spw-resonance-concept',
      'flourish:data-spw-resonance-ingredient',
      'flourish:data-spw-probe-relation',
      'structural:data-spw-block-resonance',
      'structural:data-spw-target-kin',
    ],
  ...
  },
  {
    ...
    when: MOUNT_WHEN.VISIBLE,
    costClass: COST_CLASS.DEMAND_COUPLED,
    selector: '[data-spw-feature="wrap-jobs"]',
    rootMode: 'single',
  ...
  },
  {
    ...
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.VISIBLE,
    subfeatures: ['lens-change-listener', 'semantic-lens-activator', 'content-variant-framer', 'variant-edge-reporter'],
    triggers: ['lens-change', 'query-variant'],
    affordances: ['mark-revealed-variant', 'switch-content-layer', 'compare-variants', 'inspect-from-to-edge'],
    ...
    rootMode: 'single',
    describes: 'component[variant]{mode|semantic|content} edge[from-to] query override <after:lens>',
    updates: [
  ...
  },
  {
    ...
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.VISIBLE,
    selector: '.spw-delimiter',
    rootMode: 'single',
    describes: 'sequence[delimiter]{projection} tap three delimiters inside five seconds and the run is named for the active persona',
    updates: ['structural:data-spw-selection', 'flourish:class:.spw-delight'],
    evaluates: 'delimiter sequence projection persona console',
    timingArc: 'visible-gesture',
    effectScope: 'local-dom listeners timers bus',
    load: () => import('../../semantic/projection.js'),
  },
  {
    id: 'semantics-gate',
    layer: MODULE_LAYERS.ENHANCEMENT,
    when: MOUNT_WHEN.IDLE,
    describes: 'gate[passcode]{semantics.unlocked} the weight from the hashing post, typed into the console, opens the premium semantics; a page that was opened stays open',
    updates: ['body:residue:data-spw-semantics'],
    evaluates: 'gate passcode unlock semantics residue',
    timingArc: 'enhance-collectible',
    timingChunk: 'idle-collectible',
  ...
  },
  {
    id: 'page-universe',
    layer: MODULE_LAYERS.ENHANCEMENT,
    // a page that calls itself promptable describes its own contract for the next agent
    when: MOUNT_WHEN.IDLE,
    features: ['promptability'],
    describes: 'universe[page|sections|operators|topics]{window.__spwPageUniverse} the page describes its audience, gestures, storage, and translation policy for the next reader that is an agent',
    evaluates: 'page manifest sections operators topics publisher agent-handoff',
    timingArc: 'idle-inspection',
    timingChunk: 'idle-lab',
    effectScope: 'window bus',
    load: () => import('../../semantic/page-universe.js'),
  },
  {
    id: 'cognition',
    layer: MODULE_LAYERS.ENHANCEMENT,
    // off by default; the cognitive handles setting is the reader's switch, checked per hold
    when: MOUNT_WHEN.IDLE,
    describes: 'cognition[hold|cluster]{knowledge.gained} with cognitive handles on, a sustained hold on a concept grounds it and the cognitive web panel shows what the page has gathered',
    updates: ['structural:data-spw-knowledge', 'flourish:class:.spw-delight', 'flourish:class:.spw-wonder-accent'],
    evaluates: 'cognition knowledge-gain cluster wonder-accent cognitive-surface',
    timingArc: 'enhance-metacognition',
    timingChunk: 'idle-lab',
