...
export const ATTENTION_ARCHITECTURE_CONTRACT = Object.freeze({
  ...
  attributes: Object.freeze({
    ...
    probeRelation: 'data-spw-probe-relation',
    probeFamily: 'data-spw-resonance-family',
    probeConcept: 'data-spw-resonance-concept',
    probeIngredient: 'data-spw-resonance-ingredient',
    blockResonance: 'data-spw-block-resonance',
    targetKin: 'data-spw-target-kin',
...
export function describeAttentionArchitecture(root = typeof document !== 'undefined' ? document : null) {
  ...
  return {
    ...
    probeRelation: ds.spwProbeRelation || null,
    probeFamily: ds.spwResonanceFamily || null,
    probeConcept: ds.spwResonanceConcept || null,
    probeIngredient: ds.spwResonanceIngredient || null,
    blockResonanceCount: doc.querySelectorAll?.('[data-spw-block-resonance]').length || 0,
