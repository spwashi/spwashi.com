...
const QUERY_SETTING_ALIASES = Object.freeze({
  ...
  legible: 'legibleChannel',
  lens: 'legibleChannel',
  'legible-channel': 'legibleChannel',
...
const buildPersistenceRegistries = () => ([
  ...
  },
  {
    ...
    clear() {
      ...
      // G1 bundle form (see semantic/cauldron/contract.js); kernel stays below semantic and keeps its own copy
