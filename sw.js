...
const CORE_ASSETS = [
  ...
  '/public/js/kernel/spw-page-metadata.js',
  '/public/js/typed/media-publishing.js',
  '/public/js/typed/promo-wonder-cycle.js',
  '/public/js/typed/spw-feed-utils.js',
  '/public/js/kernel/site-settings.js',
  '/public/js/modules/design-experiments.js',
  '/public/js/interface/spw-palette-resonance.js',
  '/public/js/modules/spw-math-diagrams.js',
  '/public/js/semantic/spw-component-semantics.js',
  '/public/js/interface/spw-contextual-ui.js',
  '/public/js/interface/spw-semantic-chrome.js',
  '/public/js/kernel/spw-shared.js',
  '/public/js/media/spw-image-metaphysics.js',
  '/public/js/media/spw-svg-filters.js',
  '/public/js/interface/spw-canvas-accents.js',
  '/public/js/kernel/spw-bus.js',
  '/public/js/runtime/spw-interaction-loop.js',
  '/public/js/runtime/spw-pwa-update-handler.js',
