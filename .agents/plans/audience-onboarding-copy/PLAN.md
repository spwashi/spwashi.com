...
- The site is the résumé. `/about/#about-years` and `/about/#career-register` host walkable year and practice records; they do not replace other component families. See `.agents/plans/archive/resume-record/PLAN.md`.
