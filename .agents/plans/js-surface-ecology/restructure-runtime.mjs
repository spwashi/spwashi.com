...
const jsMap = {
  ...
  modules: [
    'blog/interpreter.js',
    'blog/specimens.js',
    'blog/attn-register.js',
    'cards/seed-card.js',
    'cards/payment-card.js',
    'services/configurator.js',
    'rpg-wednesday/index.js',
    ...
    'profile/tool.js',
    'tools/budgeting.js',
    'services/care-intake.js',
    'widgets/boonhonk-mixer.js',
    'math/diagrams.js',
    'effects/electromagnetic-containers.js',
  ],
  media: [
    'spw-image-store.js',
...
const cssMap = {
  ...
  routes: [
    ...
    'routes/surfaces/tools-budgeting-surface.css',
    'routes/surfaces/design-experiments.css',
    'routes/widgets/care-intake.css',
    'routes/widgets/services-configurator.css',
    'payment-card.css',
    'seed-card.css',
    'profile-card.css',
