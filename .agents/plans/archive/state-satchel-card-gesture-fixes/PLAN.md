...
Ready for review / commit. Canonical plan copy should be placed at `.agents/plans/archive/state-satchel-card-gesture-fixes/PLAN.md`.
...
**Canonical plan location**: After landing, ensure a clean copy lives at `.agents/plans/archive/settings-widgets-low-friction/PLAN.md` (or evolve the existing palette one) for editor inspectability and future maintenance.
...
Ready for canonical copy to .agents/plans/archive/settings-widgets-low-friction/PLAN.md and optional spw-plan-maintenance.