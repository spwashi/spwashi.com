...
[NEW] `.agents/plans/archive/author-craft-ramps/PLAN.md` - human-facing plan.
[NEW] `.agents/plans/archive/author-craft-ramps/wip.spw` - living task state.
[NEW] `.agents/plans/archive/author-craft-ramps/author-craft-ramps.spw` - distilled craft ramp contract.
...
`.agents/plans/archive/author-craft-ramps/author-craft-ramps.spw`
