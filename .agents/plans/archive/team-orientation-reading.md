# Archived 2026-09-06 — team-orientation reading dump

Human reading aid, not always-on. Regenerated by `scripts/extract-site-copy.mjs` into this archive path.
Do not Open from an agent glob of `.agents/plans/**`.
