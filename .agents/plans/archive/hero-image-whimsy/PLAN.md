...
[NEW] `.agents/plans/archive/hero-image-whimsy/PLAN.md` - human-facing scope and craft guard.
[NEW] `.agents/plans/archive/hero-image-whimsy/wip.spw` - living branch memory.
