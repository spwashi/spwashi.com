...
[NEW] `.agents/plans/archive/math-topic-expansion/PLAN.md` - human-facing feature scope.
[NEW] `.agents/plans/archive/math-topic-expansion/wip.spw` - living branch memory.
