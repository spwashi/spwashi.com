...
[NEW] .agents/plans/archive/brace-literacy-guides/PLAN.md
[NEW] .agents/plans/archive/brace-literacy-guides/wip.spw
[NEW] .agents/plans/archive/brace-literacy-guides/brace-literacy-guides.spw
...
`.agents/plans/archive/brace-literacy-guides/brace-literacy-guides.spw` — a distilled note defining conceptual vs realized, substrate, phrasing, and the falsification boundary for heuristic guidance.
