...
[NEW] `.agents/plans/archive/unsorted-image-rollout/PLAN.md` - human-facing scope and guardrails.
[NEW] `.agents/plans/archive/unsorted-image-rollout/wip.spw` - living branch memory for the rollout.
