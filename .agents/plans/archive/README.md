...
These notes are historical planning artifacts that have been superseded by the
current active plan tracks.

Use the active index at `../README.md` for current work (Canonical Tracks):
...
For the full directory index (including active backlog and high-signal items), see `../README.md`.
